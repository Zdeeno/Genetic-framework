...
from ta import rsi, macd, bollinger_hband, ema
import pandas
...
class BTCBitstampNMin:
    ...
    def __init__(self, candle_min, batch_size):
        ...
        self._ema_ts = ema(pandas.Series(self._price_ts), 21).values
        ...
        self._bb_ts = self._bb_ts/self._price_ts - 1
        self._ema_ts = self._ema_ts/self._price_ts - 1
    ...
    def get_batch(self):
        ...
        ret = np.empty((self._candles_per_batch, 6))
        ...
        ret[:, 5] = self._ema_ts[batch_start:(batch_start + self._candles_per_batch)]
